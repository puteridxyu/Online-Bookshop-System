...
<body>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a  href="Application Layer/Manage Report/reportview.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Reports</span></a>
                        </li>
                        <br><br>
                        <li>
                            <a href="admin/adminlogout.php" aria-expanded="false"><span class="educate-icon educate-pages icon-wrap"></span> <span class="mini-click-non">Logout</span></a>
                        </li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="x/img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="bookhome.php" class="nav-link">Home</a>
                                                </li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item" style="margin-right: 10px;">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn"  style="margin-right:100px; width: 10px; ">
                                                        ...
                                                        <li><a href="admin/adminlogout.php" ><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
    ...
    <div class="traffic-analysis-area" style="margin-top: 10px;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									                      <div class="breadcome-heading"><br>
