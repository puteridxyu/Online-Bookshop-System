...
<body style="background-color: #F6F8FA;">
    ...
    <!-- Admin Form -->
        <section class="sign-in" >
            <div class="container" >
            <div class="signup-content" style="padding-top: 20px;">
                    <div class="signup-form" tyle="margin-top: -100px;">
                        <h2 class="form-title">Customer Sign Up</h2>
                        <form method="POST" class="register-form" id="register-form" action="../../Business Service Layer/Manage Registration/registerdata.php">
                        ...
                        <br>
                        <p>Already a member? <a href="../../admin/login.php" style="color: #4292DC;">Sign In</a></p>
                ...
                <div class="text-center login-footer" style="margin-top: -50px;"  >
                  <p style="margin-left: 300px; ">Online BookShop System · Version 2.1 · 2023</p>
                </div>
            </div>
        </section>
    </div>
