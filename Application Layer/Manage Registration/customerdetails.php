                            ...
                            <div class="asset-inner">
                                <table id="tableId">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row['Email'];?></td>
                                        <td>
                                            <button data-toggle="tooltip" title="Trash" class="pd-setting-ed" style="background-color: #D80027;"><i class="fa fa-trash-o" style="color: white;"aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                    <?php }?>
