 ...
 <article>
     ...
     <div class="container-fluid h-100 bg-light text-dark">
		  ...
		  <table id="tableHorizontalWrapper" class="table table-striped table-bordered table-sm text-center" cellspacing="0"width="100%">
                ...
                <button data-toggle="tooltip" onclick="#" title="Edit" class="btn pd-setting-ed"  style="background-color: #28A745;"><i style="color: white;" class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                <button data-toggle="tooltip" onclick="#" title="Delete" class="btn pd-setting-ed" style="background-color: #DC3545;"><i style="color: white;" class="fa fa-trash-o" aria-hidden="true"></button>
