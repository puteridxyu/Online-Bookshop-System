...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header" style="margin-top: 10px; margin-bottom: 20px;">
                <a href="index.html"><img class="main-logo" style="width: 170px; height: auto;" src="x/img/logo/logo2.png" alt="" /></a>
                <strong><a href="index.html"><img src="x/img/logo/logosn.png" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a class="has-arrow" style="margin-top: 49px;" onclick="alert('Please log in your account to continue the activity')" aria-expanded="false"><span class="educate-icon educate-library icon-wrap"></span> <span class="mini-click-non">Catalogue</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a onclick="alert('Please log in your account to continue the activity')"><span class="mini-sub-pro">English Books</span></a></li>
                                <li><a onclick="alert('Please log in your account to continue the activity')"><span class="mini-sub-pro">Malay Books</span></a></li>
                                <li><a tonclick="alert('Please log in your account to continue the activity')"><span class="mini-sub-pro">Revision Books</span></a></li>
                                <li><a onclick="alert('Please log in your account to continue the activity')"><span class="mini-sub-pro">Stationary</span></a></li>
                            </ul>
                        </li>
    ...
    <div class="all-content-wrapper">
                                        ...
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
												<li class="nav-item" style="margin-right: 10px;">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn"  style="margin-right:100px; width: 10px; ">
                                                        <li><a href="admin/login.php"><span class="edu-icon edu-home-admin author-log-ic"></span>Customer</a>
                                                        </li>
                                                        <li><a href="admin/adminlogin.php"><span class="edu-icon edu-user-rounded author-log-ic"></span>Admin</a>
                                                        </li>
                                                    </ul>
                                                </li>
        ...
        <div class="traffic-analysis-area" style="margin-top: 70px;">
                            ...
                            <div class="breadcome-list">
                                <div class="row">
									...
									<div class="breadcome-heading">
                                            <h4 style="text-align: center;">Chinese New Year 2023 Promotions | Save More, Get More! Follow us for more info 🎉 </h4>
                                        </div>
                                    </div>
                ...
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            ...
                            <div class="student-dtl">
                                <h2>The Imperfections of Memory</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<p style="margin-left: 160px;">Online BookShop System · Version 2.1 · 2023</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- counterup JS
		============================================ -->
    <script src="x/js/counterup/jquery.counterup.min.js"></script>
    <script src="x/js/counterup/waypoints.min.js"></script>
    <script src="x/js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    ...
    <!-- morrisjs JS
		============================================ -->
    <script src="x/js/morrisjs/raphael-min.js"></script>
    <script src="x/js/morrisjs/morris.js"></script>
    <script src="x/js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="x/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="x/js/sparkline/jquery.charts-sparkline.js"></script>
    <script src="x/js/sparkline/sparkline-active.js"></script>
    <!-- calendar JS
		============================================ -->
